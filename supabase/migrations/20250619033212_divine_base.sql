/*
  # Fix administrator access for events and profiles

  1. Changes
    - Update RLS policies to correctly check friend_id instead of user_id for administrator access
    - Ensure policies don't conflict with existing ones by dropping them first
    - Fix the relationship direction in the friendships check

  2. Security
    - Maintain proper access control while fixing the administrator access check
    - Ensure users can only manage profiles and events they own or have administrator access to
*/
